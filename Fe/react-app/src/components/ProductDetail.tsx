      ...
      <div className="pdp-img-container">
        ...
        <div className="pdp-details-container">
          ...
          <button className="pdp-tag">Doux</button>
            <h2>{currency}</h2>
            <p className="pdp-area" onClick={() => changePrice(2)}>{product.commune }</p>
          </div>
          
              <div className="qty-container">
          <label htmlFor="pdp-qty-select">qty</label>
            <select name="selectQuantity" id="pdp-qty-select" value={quantitySelect} onChange={handleQuantityChange}>
              {
          ...
          <p className="pdp-description" onClick={() => searchForProduct(2)}>{product.description}</p>
          <p></p>
          </div>
      </section>
    </div>
