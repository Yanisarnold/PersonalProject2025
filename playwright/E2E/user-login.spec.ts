...
test.describe("User Authentication Page", () => {
  ...
  test('Verify user is able to login with valid credential', { tag: ['@e2e', '@regression'] }, async ({ page }) => {
  ...
  test.only("Verify user can't login with invalid credential", async ({ page }) => {
